...
public class EditEvent extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private Modal modal;
    public static String CLASS_ARG = "CLASS";
    public static String ID_ARG = "ID";
    public static String NAME_ARG = "NAME";
    public static String DATE_ARG = "DATE";
    public static String TIME_ARG = "TIME";
    public static String DESCRIPTION_ARG = "DESCRIPTION";
    private String category;
    private String comingName;
    private String comingDate;
    private String comingTime;
    private String comingDescription;
    private int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = getIntent().getStringExtra(CLASS_ARG);
        comingName = getIntent().getStringExtra(NAME_ARG);
        comingDate = getIntent().getStringExtra(DATE_ARG);
        comingTime = getIntent().getStringExtra(TIME_ARG);
        comingDescription = getIntent().getStringExtra(DESCRIPTION_ARG);
        id = getIntent().getIntExtra(ID_ARG, 0);
            ...
            switch (category) {
                    ...
                    OtherEventAdapter otherEventAdapter;
                {
                    ...
                    switch (comingName) {
                        ...
                        case "Take warm water with lime" :{
        ...
        description.setText(comingDescription);

        DateUtills dateUtills = new DateUtills(this);
        date = (TextView) findViewById(R.id.date);
        date.setText(comingDate);
        date.setOnClickListener(this);
        String[] timeFormatted = comingTime.split(":");
        time = (TextView) findViewById(R.id.time);
        time.setText(dateUtills.getRemindTime(Integer.parseInt(timeFormatted[0]), Integer.parseInt(timeFormatted[1].split(" ")[0])));
        time.setOnClickListener(this);

        eventInfo = new EventInfo();
        eventInfo.setEventDate(comingDate);

        eventInfo.setEventTime(dateUtills.getRemindTime(Integer.parseInt(timeFormatted[0]), Integer.parseInt(timeFormatted[1].split(" ")[0])));
        eventInfo.setEventClass(category);
        eventInfo.setEventDescription(comingDescription);
        eventInfo.setId(id);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save: {
                ...
                if (!eventDescription.isEmpty()) {
                    ...
                    modal.updateEvent(eventInfo, id);
                    onBackPressed();
                } else
                    Toast.makeText(EditEvent.this, "Please enter description first", Toast.LENGTH_SHORT).show();
                break;
            }
            ...
            case R.id.action_delete: {
                modal.deleteEvent(category, comingName, comingDate, comingTime, comingDescription, id);
                onBackPressed();
            }
        }
        return true;
